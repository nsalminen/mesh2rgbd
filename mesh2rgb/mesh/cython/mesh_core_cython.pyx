...
def render_rgbd_core(np.ndarray[float, ndim=3, mode = "c"] image not None,
                np.ndarray[float, ndim=2, mode = "c"] vertices not None, 
                np.ndarray[int, ndim=2, mode="c"] triangles not None,
                np.ndarray[int, ndim=1, mode = "c"] triangle_mask not None,
    ...
    _render_rgbd_core(
        ...
        <int*> np.PyArray_DATA(triangle_mask),
